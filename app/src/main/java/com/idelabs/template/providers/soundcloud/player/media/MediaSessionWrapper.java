package com.idelabs.template.providers.soundcloud.player.media;
...
import com.idelabs.template.providers.soundcloud.player.remote.RemoteControlClientCompat;
import com.idelabs.template.providers.soundcloud.player.remote.RemoteControlHelper;
...
public class MediaSessionWrapper {
     ...
     */
    static final String ACTION_TOGGLE_PLAYBACK = "com.idelabs.template.providers.soundcloud.library.media.TOGGLE_PLAYBACK";

    /**
     * Action used to catch broadcast from {@link .MediaSessionReceiver}
     */
    static final String ACTION_NEXT_TRACK = "idelabs.universal.soundcloud.library.media.NEXT_TRACK";

    /**
     * Action used to catch broadcast from {@link MediaSessionReceiver}
     */
    static final String ACTION_PREVIOUS_TRACK = "com.idelabs.template.providers.soundcloud.library.media.PREVIOUS_TRACK";
